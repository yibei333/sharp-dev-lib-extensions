...
internal enum InternalChainingMode
{
    /// <summary>
    ...
    internal class EncryptionKeyData : XmlHelper
    {
        ...
        private static InternalHashAlogorithm GetHashAlgorithm(string v)
        {
            return v switch
            {
                ...
                _ => Enum.TryParse(typeof(InternalHashAlogorithm), v, out var result) ? (InternalHashAlogorithm)result! : throw new InvalidDataException("Invalid Hash algorithm"),
            };
        }
        ...
        internal InternalChainingMode CipherChaining
        {
            get => Enum.TryParse(typeof(InternalChainingMode), GetXmlNodeString("@cipherChaining"), out var result) ? (InternalChainingMode)result! : throw new InvalidDataException("Invalid chaining mode");
            set => SetXmlNodeString("@cipherChaining", value.ToString());
        }
        ...
        private static InternalCipherAlgorithm GetCipherAlgorithm(string v)
        {
            return v switch
            {
                ...
                _ => Enum.TryParse(typeof(InternalCipherAlgorithm), v, out var result) ? (InternalCipherAlgorithm)result! : throw new InvalidDataException("Invalid Hash algorithm"),
            };
        }
